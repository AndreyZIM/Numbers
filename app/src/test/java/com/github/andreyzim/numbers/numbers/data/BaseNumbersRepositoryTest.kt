...
class BaseNumbersRepositoryTest {
    ...
    fun setUp() {
        ...
        repository = BaseNumbersRepositoryTest(cloudDataSource, cacheDataSource)
    }

    @Test
    fun test_allNumbers() = runBlocking {
        ...
        actual.forEachIndexed { index, numberFact ->
            assertEquals(expected[index], numberFact)
        }
